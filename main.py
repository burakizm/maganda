...
def button():
	BUTTON=[[InlineKeyboardButton(text="👨🏻‍💻 Sahibim ",url="https://t.me/burakizm")]]
	BUTTON+=[[InlineKeyboardButton(text="🌱 Diğer botlar🌱",url="https://t.me/flackwardev")]]
...
async def _(client, message):
	...
	await message.reply_text(text="**Merhaba {}!**\n\n__Ben Flackwar DC oyun botuyum:) \nDiğer botlarımıza da göz atmak ister misiniz? [FLACKWAR DEV](https://t.me/flackwardev)  Oyun Komutu => /dc".format(
