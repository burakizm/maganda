...
def button():
	BUTTON=[[InlineKeyboardButton(text="👨🏻‍💻 Sahibem ",url="https://t.me/loresimadsiz")]]
	BUTTON+=[[InlineKeyboardButton(text="🌱 Sohbet&oyun 🌱",url="https://t.me/smailesi")]]
...
async def _(client, message):
	...
	await message.reply_text(text="**Merhaba {}!**\n\n__Ben Mango Eğlence Botuyum:) \nKelime botumuzu denediniz mi @MangoKelime_bot Oyun Komutu => /dc".format(
